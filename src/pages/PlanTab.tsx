        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border-2 border-gray-100 rounded-3xl p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-black uppercase text-sm tracking-widest text-gray-900">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {plan.hookMix.map((h, i) => (
                ...
                >
                  ...
                  <p className="text-[11px] text-gray-600">{h.rationale}</p>
                </div>
              ))}
            </div>
          </div>
            ...
            >
              <div className="space-y-2 mt-2">
                {plan.awarenessCoverage.map((a, i) => (
                  <div
                    key={i}
                    className="flex items-start justify-between gap-3 p-2 bg-purple-50 rounded-lg"
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <div className="grid grid-cols-2 gap-3 my-2">
                ...
                <div>
                  <div className="text-[10px] uppercase tracking-widest text-green-700 font-bold">
                    Recomendado
                  </div>
                  <div className="text-2xl font-black text-green-700">
                    R${plan.budget.dailyRecommended}
                    <span className="text-xs font-normal text-green-600">/dia</span>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="space-y-2 text-xs">
                ...
                <div>
                  ...
                  <span className="text-gray-900">{plan.iterationPlan.killThreshold}</span>
                </div>
                <div>
          ...
          {plan.nextSteps?.length > 0 && (
            <div className="bg-white border-2 border-gray-900 rounded-3xl p-6">
              <div className="flex items-center gap-2 mb-3">
                <CheckSquare size={18} className="text-gray-900" />
                <h3 className="font-black uppercase text-xs tracking-widest text-gray-900">
