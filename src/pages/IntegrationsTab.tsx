...
export function IntegrationsTab({
  ...
  return (
    <div className="max-w-[1600px] mx-auto space-y-8">
      <div className="p-8 bg-white/80 dark:bg-gray-900/60 backdrop-blur-sm rounded-3xl ring-1 ring-gray-200/60 dark:ring-gray-800/60 shadow-xl shadow-gray-200/40 dark:shadow-black/30 space-y-6">
